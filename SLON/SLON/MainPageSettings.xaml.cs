...
namespace SLON
{
    ...
    {
        // Ћокальные временные копии настроек
        ...
        public MainPageSettings(MainPage mainPage)
        {
            ...
            // »нициализируем локальные копии из глобальных настроек
            ...
            // ”станавливаем выбранные даты
            startDatePicker.Date = tempStartDate;
            endDatePicker.Date = tempEndDate;

            // ќтображаем блок настроек дл€ событий только если выбран режим ивентов
            ForEvent.IsVisible = (mainPage.ProfilesEventsButtonStatus == 1);

            // «аполн€ем список категорий
            categories.Add("IT");
            ...
            // ¬осстанавливаем сохранЄнное состо€ние дл€ событий
        ...
        {
            // —охран€ем выбранные даты в глобальные настройки (только дл€ событий)
            if (mainPage.ProfilesEventsButtonStatus == 1)
            {
                Settings.SelectedEventStartDate = startDatePicker.Date;
                Settings.SelectedEventEndDate = endDatePicker.Date;
            }
            // —охран€ем локальные изменени€ по категори€м и типам событий
